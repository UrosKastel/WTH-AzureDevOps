...
2. Download the code for the application [here](https://minhaskamal.github.io/DownGit/#/home?url=https://github.com/UrosKastel/WTH-AzureDevOps/blob/master/code/What-The-Hack-Azure-DevOps-NET5.zip).
